...
<div className="tricot-hero-links">
  <a className="tricot-hero-link" href="/print-section?id=06-execution">📄 Download the Execution chapter as a PDF</a>
</div>
<br />

# Trial execution

> Taken from van Etten et al. [-@vanEtten2020], page 19
