...
<div className="tricot-hero-links">
  <a className="tricot-hero-link" href="/print-section?id=04-recruitment">📄 Download the Recruitment chapter as a PDF</a>
</div>
<br />

# Tricot trial recruitment

> Taken from van Etten et al. [-@vanEtten2020], page 15
...
The [**sampling sub-chapter of this book**](/design/sampling-plots#introduction) explains the socioeconomic aspects to consider (e.g. gender, age and ethnicity) when recruiting participants for a tricot trial. 
