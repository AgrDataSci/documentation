...
**Binning**
A privacy-preserving method that groups numerical values into intervals or ranges instead of displaying exact values.
...
**Confidential data**
Data that should be protected or excluded from shareable datasets, including personally identifiable, sensitive, strategic, or institutionally restricted information.
...
**Month-year**
A privacy-preserving method that removes the exact day from date values, preserving only the month and year.

**Noise**
A privacy-preserving method that modifies geographic coordinates to reduce the precision of location information.
...
Information that can directly or indirectly identify an individual, such as names, phone numbers, email addresses, or exact locations.
...
Techniques used to protect confidential data in exported datasets while maintaining data usability for analysis, reporting, or sharing.

**Pseudonymization**
A privacy-preserving method that replaces identifiable information with generated codes or identifiers.
...
**Removal**
A privacy-preserving method that completely excludes information from exported datasets.
...
**Shareable data**
Exported datasets processed using privacy-preserving methods to reduce the exposure of confidential data while preserving data usability.
