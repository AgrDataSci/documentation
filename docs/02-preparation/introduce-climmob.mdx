...
The **Project overview** is the central workspace for managing a project in ClimMob. From this page, you can access the different project activities throughout the project life cycle, including project configuration, participant registration, trial package preparation, data collection, downloads, project documentation, and collaboration features.

Most project activities described in this ebook are accessed from the **Project overview**, while reusable resources such as field agents, technologies, questions and local languages are managed through the **Library**.

The Project overview also supports project monitoring throughout the project lifecycle. The Monitoring your project section explains how to use this workspace to review project progress and access key project information. 

#### **Projects**

The Projects section displays all projects that you own or collaborate on.

The **All projects** table provides an overview of your projects and allows you to quickly identify their status, access project details, and perform available actions. This section is particularly useful when managing multiple projects simultaneously.

#### **Library**

The **Library** contains reusable elements that can be shared across multiple projects. Instead of creating the same resources every time you start a new project, ClimMob stores them in the Library so they can be managed consistently and reused whenever needed. 

*	**Field agents:** are the individuals responsible for registering participants and collecting data in the field. Once created, they can be assigned to multiple projects. *	**Technologies:** represent the interventions being evaluated (for example, bean varieties, fertilizer regimes, or planting methods). Each technology contains one or more **technology options**, which can be assigned to projects and reused across multiple experiments.
*	**Questions:** ClimMob provides a library of evaluation questions developed by the 1000FARMS team, available in multiple languages and ready to use across projects. You can also create your own questions, which are stored in the Library and can be reused in future projects.
* **Local languages:** support multilingual data collection by allowing ClimMob forms to be translated and used in different languages. This includes translated questions available from the Library, translation tools for custom questions, and common phrases used in data collection forms.
