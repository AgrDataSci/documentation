...
Data collection should be done as part of the ClimMob workflow. [See this section for details on data collection.] (/design/climmob-setup#11-start-an-assessment)
