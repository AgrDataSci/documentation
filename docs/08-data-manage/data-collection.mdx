...
<div className="tricot-hero-links">
  <a className="tricot-hero-link" href="/print-section?id=08-compilation">📄 Download the Compilation chapter as a PDF</a>
</div>
<br />
...
Once a data collection moment has been started, field agents can begin collecting observations from participants using the configured trial data collection forms.

Before collecting data, make sure that:

* The trial packages have been prepared and distributed to participants.
* The participants have been registered.
* The corresponding data collection moment has been started.
* Field agents have been assigned to the project.

See [**Assign field agents**](/recruitment/field-agents) and [**Start a data collection moment**](/execution/start-data-collection) for more information.

ClimMob supports different approaches for collecting data, depending on the needs and resources available for each project:

* **ODK Collect (recommended):** Field agents collect data using the ClimMob forms available on their mobile devices.
* **Excel upload:** Data collected outside ClimMob can be uploaded using an Excel template.
* **Submit data from a browser:** Field agents complete forms online using a browser through Enketo.
...
(The following steps are accompanied by the relevant screenshots of ClimMob)
