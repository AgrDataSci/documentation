...
ClimMob and the tricot methodology were initiated by Jacob van Etten, PhD, and developed by a team of researchers and programmers at the Alliance of Bioversity International and CIAT (CGIAR), now led by Kauê de Sousa. Learn more about the development process through this publication in Experimental Agriculture: Jacob van Etten, et al. 2019. First experiences with a novel farmer citizen science approach: Crowdsourcing participatory variety selection through on-farm triadic comparisons of technologies (tricot). Experimental Agriculture, 55(S1). https://doi.org/10.1017/S0014479716000739) _add OFE conference keynote here_
...
To help estimate tricot trial costs, we have developed guidelines and templates that can be filled in this section _(link to costing templates)_.
