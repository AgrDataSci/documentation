...
* Snacks
* Trial packages [see next section](https://agrdatasci.github.io/documentation/distribution/packages#every-trial-package-should-contain-the-following-four-elements) 
