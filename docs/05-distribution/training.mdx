...
<div className="tricot-hero-links">
  <a className="tricot-hero-link" href="/print-section?id=05-distribution">📄 Download the Distribution chapter as a PDF</a>
</div>
<br />

# Training workshop

> Taken from van Etten et al. [-@vanEtten2020], page 17
