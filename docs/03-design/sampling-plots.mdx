...
<div className="tricot-hero-links tricot-tabs">
  <a href="#socio-economic-sampling" className="tricot-hero-link">👥 Socio-economic sampling</a>
  <a href="#geographic-sampling" className="tricot-hero-link">🗺️ Geographic sampling</a>
...
# Socioeconomic sampling {#socio-economic-sampling}
