...
This can be done through meetings with community leaders, key informants, transect walks, and interviews with people involved in crop-related work.
...
For the further sake of social differentiation and allowing to segment the dataset later, a RHoMIS core social questionnaire will be administered with each of the chosen participants.
