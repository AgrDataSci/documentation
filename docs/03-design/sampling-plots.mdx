...
> Béla Teeken, Jill Cairns, Mainassara Abdou Zaman-Allah, Joost van Heerwaarden

<div className="tricot-hero">
   <p className="tricot-hero-text">
    Here are some resources for the sampling and plot design of tricot experiments regarding socio-economics, geography and plot design.
  </p>
