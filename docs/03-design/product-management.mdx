...
Traits within a TPP are organized into two main categories based on their significance and role in the breeding process:

1.	Essential traits: Must be present in all new products for the market segment. They are critical to meeting or exceeding stakeholder expectations (e.g., disease resistance, yield stability). Within essential traits there two categories:
...
2.	Nice-to-have traits: Traits that add value but are not mandatory for the product to succeed in the market. Their inclusion can provide a competitive edge but is not essential (e.g., aesthetic appeal, niche taste preferences).
